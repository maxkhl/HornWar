...
namespace Horn_War_II.GameObjects.Weapons
{
    ...
    class Staff : Weapon
    {
        ...
        public Staff(Scenes.GameScene GameScene, PhysicEngine PhysicEngine)
            : base(GameScene, PhysicEngine)
        {
            this.Texture = new hTexture(Game.Content.Load<Texture2D>("Images/Staff"));
        ...
        public override void Attach(Character Character)
        {
            ...
            AttachmentJoint.LocalAnchorA = ConvertUnits.ToSimUnits(new Vector2(0, 0));
